...
That is because `kw patch-hub` is a screen-driven feature that displays screens using [dialog](https://linux.die.net/man/1/dialog) that transitions depending on the input the feature receives. This results in many of the functions having a similar structure:
